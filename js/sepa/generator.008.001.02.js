...
const generate = (billSpec, billList) => {
    ...
    root.attribute('xsi:schemaLocation', 'urn:iso:std:iso:20022:tech:xsd:pain.008.001.02 pain.008.001.02.xsd');
    root.attribute('xmlns', 'urn:iso:std:iso:20022:tech:xsd:pain.008.001.02');
    // the three lines before are the only difference to 002.02
...
const addPaymentInfo = function(paymentRoot, billSpec, bill) {
    ...
    // HERE DIFF - OPTIONAL
    //DrctDbtTx.ele('AmdmntInd', true);
    //var AmdmntInfDtls =DrctDbtTx.ele('AmdmntInfDtls');
    // END DIFF
